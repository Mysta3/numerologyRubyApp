...
if (sum > 9)
    ...
    when 5
        puts "This is the freedom lover. THe number five is an intellectual vibration. These are 'ideai' people with a love variety and the ability to adapt to most situations. Ruled by Mercury."
    when 6
